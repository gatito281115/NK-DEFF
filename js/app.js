...
const cafes = document.getElementById('lista-Gorras');
const listaGorras = document.querySelector('#lista-carrito tbody');
...
function vaciarCarrito() {
    while(listaGorras.firstChild){
        listaCafes.removeChild(listaGorras.firstChild);
